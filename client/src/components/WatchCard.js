        ...
        return(
          <div className="container-fluid">
              ...
              <h3 className="animated bounceInLeft delay-5s">{this.props.profileUsername}</h3>
                ...
                <li className="nav-item">
                  <a className="nav-link btn-outline-info animated fadeInLeft delay-5s" href="#frequency">Frequency Commits</a>
                </li>
                <li className="nav-item">
              ...
              <div className="col-sm-9 col-8" id="watch-div">
              <div className="info"id="notification"> 
                ...
                <img class="card-img-top" src={this.props.profile.image_url} alt="img"/>
                    <div class="card-body">
                    <h4 class="card-title">Watched Repository Information</h4>
                      <p class="card-text">Username : {this.props.profile.username}</p> 
                      <p class="card-text">Repository name : {this.props.profile.reponame}</p>
                      <p class="card-text">Created at : {this.props.profile.created_at}</p>
                      <p class="card-text">Updated at : {this.props.profile.updated_at}</p>
                      <p class="card-text">Pushed at : {this.props.profile.pushed_at}</p>
                      <p class="card-text">Issue : {this.props.profile.num_issue}</p>
                </div>
                    </div>
                </div>
                <div className="col-md-6">
                <div id="overall-card"class="card border-0 animated bounceInRight delay-5s">
                        <div class="card-body">
                        <h4 class="card-title">Notification Trigger</h4>
                        <NotificationCard/>
                    </div>
                </div>
                <div id="overall-card"class="card border-0 animated bounceInRight delay-5s">
                        <div class="card-body">
                        <h4 class="card-title">Repository Overall Score</h4>
                        <OverallHealthCard/>
                    </div>
                </div>
                </div>
